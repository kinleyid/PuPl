function Params = FindOffset(Struct1,Struct2,Struct1EventBins,Struct2EventBins)
...
while true
    ...
    for CandidateOffset = AllPossibleOffsets
        ...
        Params = [Struct2TimesVector ones(size(Struct1TimesVector))]\Struct1TimesVector;
        Errs = Struct1TimesVector - [Struct2TimesVector ones(size(Struct1TimesVector))]*Params;
        MSE = mean(Errs.^2);
        if MSE < LowestMSE
            LowestErr = Errs;
            LowestMSE = MSE;
