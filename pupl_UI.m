...
mainFigure = figure('Name', 'Pupillometry',...
    'NumberTitle', 'off',...
...
c = uicontrol(mainFigure,...
    'Style', 'Checkbox',...
    'String', {'Option 1', 'Opt', 'Swag'});
...
uimenu(fileMenu,...
    'Text', '&Import',...
    'MenuSelectedFcn', @(h, e)...
        cellfun(@(x)feval(f, h, e),...
            {pupl_format('type', 'eye data', 'UI', mainFigure)
             update_UI(mainFigure)}));
uimenu(fileMenu,...
    'Text', '&Load',...
    'MenuSelectedFcn', @(h, e)...
        cellfun(@(x)feval(f, h, e),...
            {pupl_load('type', 'eye data', 'UI', mainFigure)
             update_UI(mainFigure)}));
uimenu(fileMenu,...
    'Text', '&Save',...
