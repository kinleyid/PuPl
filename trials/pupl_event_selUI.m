...
uicontrol(f,...
    ...
    'String', listbox_str,...
    'Units', 'normalized',...
    'Position', [0.01 0.26 0.98 0.63])
p1 = uipanel(f,...
    'Title', 'Regular expression filter',...
    'Units', 'normalized',...
    'Position', [0.01 0.11 0.48 0.13]);
uicontrol(p1,...
    'Style', 'edit',...
...
p2 = uipanel(f,...
    ...
    'Units', 'normalized',...
    'Position', [0.51 0.11 0.48 0.13]);
uicontrol(p2,...
    'Style', 'edit',...
    'TooltipString', pupl_gettooltip('eventvar:edit'),...
    'Tag', 'evar',...
    'Units', 'normalized',...
    'Position', [0.01 0.01 0.98 0.98],...
...
if buttons
    ...
    uicontrol(f,...
        ...
        'TooltipString', pupl_gettooltip('eventvar:button'),...
        'Units', 'normalized',...
...
set(n_sel, 'String', sprintf('%d/%d selected', nnz(idx), numel(ud.events)));
