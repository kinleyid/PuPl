...
uimenu(toolsMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata),...
    'Callback', @(src, event)...
        updateactivedata(@() arrayfun(@(x) x.getraw(), getactivedata)));
...
trialsMenu = uimenu(userInterface,...
    'Label', 'T&rials',...
    'UserData', @() isnonemptyfield(getactivedata, 'diam', 'both'));
...
uimenu(scrollMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'diam', 'left'),...
    'Callback', @(src, event)...
        plotforeach(getactivedata, @pupl_scrollplot, 'type', 'diam'));
uimenu(scrollMenu,...
    'Label', 'Ga&ze',...
    'UserData', @() isnonemptyfield(getactivedata, 'gaze', 'x'),...
    'Callback', @(src, event)...
        plotforeach(getactivedata, @pupl_scrollplot, 'type', 'gaze'));
uimenu(plottingMenu,...
