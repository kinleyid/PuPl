...
uimenu(areaDiamConversionMenu,...
    ...
    'Callback', @(src, event)...
        updateglobals('eyeData',...
            getfield(get(userInterface, 'UserData'), 'activeEyeDataIdx'),...
            @() pupl_areadiamconversion(getactive('eye data'), 'diam'),...
            1));
uimenu(areaDiamConversionMenu,...
    ...
    'Callback', @(src, event)...
        updateglobals('eyeData',...
            getfield(get(userInterface, 'UserData'), 'activeEyeDataIdx'),...
            @() pupl_areadiamconversion(getactive('eye data'), 'area'),...
            1));
...
uimenu(plottingMenu,...
    ...
    'UserData', @() isnonemptyfield(getactive('eye data'), 'gaze'),...
    'Callback', @(src, event)...
        plotforeach(getactive('eye data'), @gazescatter));
uimenu(plottingMenu,...
...
plotTrialSetsMenu = uimenu(plottingMenu,...
    ...
    'UserData', @() isnonemptyfield(getactive('eye data'), 'trialset')...
        && isnonemptyfield(getactive('eye data'), 'diam', 'both'));
...
uimenu(plotTrialSetsMenu,...
    ...
    'UserData', @() isnonemptyfield(getactive('eye data'), 'cond'),...
    'Callback', @(src, event)...
        plottrialaverages(getactive('eye data'), 'bycond', true));
uimenu(plotTrialSetsMenu,...
    'Label', '&Heatmap (similar to EEGLAB erpimage)',...
    'Callback', @(src, event)...
