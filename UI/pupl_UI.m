...
uimenu(fileMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata),...
    'Callback', @(src, event)...
        pupl_save(getactivedata, 'method', 'batch'));
%% BIDS sub-menu
...
uimenu(bidsmenu,...
    'Label', '&Save',...
    'UserData', @() isnonemptyfield(getactivedata),...
    'Callback', @(src, event) pupl_save(getactivedata, 'method', 'bids'));
...
uimenu(editMenu,...
    ...
    'Separator', 'on',...
    'UserData', @() isnonemptyfield(getactivedata),...
    'Callback', @(src, event) pupl_UI_procwrap(@pupl_rmeye));
uimenu(editMenu,...
...
tvarMenu = uimenu(trialsMenu,...
    'Label', 'Trial &variables',...
    'UserData', @() isnonemptyfield(getactivedata, 'event'));
uimenu(tvarMenu,...
...
uimenu(tvarMenu,...
    'Label', 'Read trial variables from event &names',...
    'Callback', @(src, event)...
        pupl_UI_procwrap(@pupl_tvar_read, 'method', 're'));
uimenu(tvarMenu,...
    'Label', '&Compute trial variables',...
    'Callback', @(src, event)...
        pupl_UI_procwrap(@pupl_tvar_read, 'method', 'tvar'));
uimenu(tvarMenu,...
    'Label', 'Make &string trial variables numeric',...
    'UserData', @() ~isempty(pupl_tvar_getnames(mergefields(getactivedata, 'event'))),...
    'Callback', @(src, event)...
...
uimenu(tvarMenu,...
    'Label', '&Filter test',...
    'Callback', @(src, event)...
        pupl_event_UIget(mergefields(getactivedata, 'event'), 'Test filter', false));
