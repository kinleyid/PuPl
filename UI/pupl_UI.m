...
uimenu(areaDiamConversionMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'pupil'),...
    'Callback', @(src, event)...
        pupl_UI_procwrap(@pupl_ad_convert, 'diameter'));
uimenu(areaDiamConversionMenu,...
    'Label', '&Diameter to area',...
    'UserData', @() isnonemptyfield(getactivedata, 'pupil'),...
    'Callback', @(src, event)...
        pupl_UI_procwrap(@pupl_ad_convert, 'area'));
...
blinksMenu = uimenu(processingMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'pupil'));
uimenu(blinksMenu,...
    'Label', 'Identify blinks using pupillometry &noise (requires curve-fitting toolbox)',...
    'UserData', @() isnonemptyfield(getactivedata, 'pupil'),...
    'Callback', @(src, event)...
...
uimenu(scrollMenu,...
    ...
    'Callback', @(src, event)...
        plotforeach(getactivedata, @scrollplot, 'type', 'pupil'));
uimenu(scrollMenu,...
    'Label', 'Ga&ze',...
...
uimenu(experimentmenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'epochset'),...
    'Callback', @(src, event)...
        pupl_export(getactivedata, 'cfg', struct(...
            'start', [],...
            'end', [],...
            'width', '0',...
            'step', '1dp')));
