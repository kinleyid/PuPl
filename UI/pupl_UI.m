...
uimenu(areaDiamConversionMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'diam'),...
    'Callback', @(src, event)...
        updateactivedata(@() pupl_areadiamconversion(getactivedata, 'diameter')));
uimenu(areaDiamConversionMenu,...
...
uimenu(processingMenu,...
    'Label', '&Normalize pupil size data',...
    'UserData', @() isnonemptyfield(getactivedata, 'diam'),...
    'Callback', @(src, event)...
        updateactivedata(@() pupl_normalize(getactivedata)));
...
uimenu(trimmingMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'gaze'),...
    'Callback', @(src, event)...
        updateactivedata(@() dilationspeedrej(getactivedata)))
uimenu(trimmingMenu,...
...
uimenu(filterMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'diam'),...
    'Callback', @(src, event)...
        pupl_UI_sdwrap(@pupl_filt, 'datatype', 'dilation'));
uimenu(filterMenu,...
    'Label', '&Gaze',...
    'UserData', @() isnonemptyfield(getactivedata, 'gaze'),...
    'Callback', @(src, event)...
        pupl_UI_sdwrap(@pupl_filt, 'datatype', 'dilation', 'filtertype', 'median'));
...
uimenu(interpMenu,...
    ...
    'UserData', @() isnonemptyfield(getactivedata, 'diam'),...
    'Callback', @(src, event)...
        pupl_UI_sdwrap(@pupl_interp, 'data', 'diam'));
uimenu(interpMenu,...
    'Label', '&Gaze',...
    'UserData', @() isnonemptyfield(getactivedata, 'gaze'),...
    'Callback', @(src, event)...
        pupl_UI_sdwrap(@pupl_interp, 'data', 'gaze'));
uimenu(processingMenu,...
