function bestParams = findoffset(EYE, eventLog, eyeEventSets, eventLogEventSets, varargin)
...
for cIdx = 1:numel(eyeEventSets) % correspondence idx
    ...
    eventLogTimes = reshape(...
        [eventLog.event(ismember({eventLog.event.type}, eventLogEventSets{cIdx})).time],...
        1, []);
