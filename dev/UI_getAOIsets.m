...
function AOIsets = UI_getAOIsets(EYE)
...
listboxregexp(createBinsSubPanel, unique(mergefields(EYE, 'aoi', 'name')));
uicontrol(createBinsPanel,...
    'Style', 'pushbutton',...
    'String', 'Create set',...
    'Callback', @createbin,...
